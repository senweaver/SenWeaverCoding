...
fn canonical_alias(id: &str) -> Option<&'static str> {
    Some(match id {
        ...
        "thepaper" | "paper" | "pengpai" | "澎湃" => "thepaper",
        "sohu" | "搜狐" => "sohu",
        "pubmed" | "ncbi" => "pubmed",
        "arxiv" => "arxiv",
        ...
        "v2ex" => "v2ex",
        "segmentfault" | "segment_fault" | "segfault" | "sf" | "思否" => "segmentfault",
        "sspai" | "少数派" => "sspai",
...
fn build_registry() -> EngineRegistry {
    ...
    engines.push(Arc::new(E::duckduckgo::DuckDuckGoEngine));
    engines.push(Arc::new(E::baidu::BaiduEngine));
    engines.push(Arc::new(E::brave::BraveEngine));
    engines.push(Arc::new(E::searxng::SearXNGEngine));
    engines.push(Arc::new(E::github_code::GitHubCodeEngine));

    #[cfg(feature = "tool-search-broad")]
    {
        engines.push(Arc::new(E::bing::BingEngine));
        engines.push(Arc::new(E::jina::JinaEngine));
        engines.push(Arc::new(E::google_scholar::GoogleScholarEngine));
        ...
        // News (5)
        engines.push(Arc::new(E::google_news::GoogleNewsEngine));
        engines.push(Arc::new(E::bing_news::BingNewsEngine));
        ...
        // Image
        engines.push(Arc::new(E::duckduckgo_images::DuckDuckGoImagesEngine));
        // GitHub multi-endpoint engines (code search / issues / users / advanced)
        engines.push(Arc::new(E::github_code_search::GitHubCodeSearchEngine));
        engines.push(Arc::new(E::github_issues::GitHubIssuesEngine));
        engines.push(Arc::new(E::github_users::GitHubUsersEngine));
        engines.push(Arc::new(E::github_advanced::GitHubAdvancedEngine));
    }
