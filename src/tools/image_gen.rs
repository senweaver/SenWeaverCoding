...
mod tests {
    ...
    async fn missing_api_key_returns_error() {
        ...
        crate::util::remove_env_var("FAL_API_KEY_TEST_IMAGE_GEN");
        ...
        if let Some(val) = original {
            crate::util::set_env_var("FAL_API_KEY_TEST_IMAGE_GEN", val);
        }
    }
    ...
    async fn invalid_size_returns_error() {
        ...
        crate::util::set_env_var("FAL_API_KEY_TEST_SIZE", "dummy_key");
        ...
        crate::util::remove_env_var("FAL_API_KEY_TEST_SIZE");
    }
    ...
    async fn invalid_model_with_traversal_returns_error() {
        crate::util::set_env_var("FAL_API_KEY_TEST_MODEL", "dummy_key");
    ...
    fn read_api_key_present() {
        crate::util::set_env_var("ZC_IMAGE_GEN_TEST_KEY", "test_value_123");
        let result = ImageGenTool::read_api_key("ZC_IMAGE_GEN_TEST_KEY");
        assert!(result.is_ok());
        assert_eq!(result.unwrap(), "test_value_123");
        crate::util::remove_env_var("ZC_IMAGE_GEN_TEST_KEY");
    }
}
