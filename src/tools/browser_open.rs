...
async fn open_in_system_browser(url: &str) -> anyhow::Result<()> {
    #[cfg(target_os = "macos")]
    {
        ...
        // Brave Browser fallback for macOS — retained for compatibility across
        // environments where default-browser launch may not be available.
    ...
    #[cfg(target_os = "linux")]
    {
        ...
        // Brave Browser fallback commands (brave-browser/brave) — retained for
        // environments where default launcher coverage is not yet validated.
        anyhow::bail!(
    ...
    #[cfg(target_os = "windows")]
    {
        ...
        // Brave Browser fallback for Windows — retained for compatibility across
        // environments where rundll32 default-browser launch may not be available.
        let mut brave_error = String::new();
