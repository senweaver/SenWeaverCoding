...
use crate::tools::mcp::protocol::{INTERNAL_ERROR, JsonRpcError, JsonRpcRequest, JsonRpcResponse};
...
impl SseTransport {
    ...
    async fn ensure_connected(&mut self) -> Result<()> {
        ...
        let task = crate::runtime::spawn_supervised(
            format!("tools.mcp_transport.sse_reader.{}", self.server_name),
            async move {
                let stream = resp
                    .bytes_stream()
                    ...
                    tokio::select! {
                        ...
                        line = lines.next_line() => {
                            ...
                            if let Some(rest) = line.strip_prefix("data:") {
                                ...
                                cur_data.push(trimmed.to_string());
                            }
