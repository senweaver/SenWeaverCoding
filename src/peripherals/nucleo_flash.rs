...
/// Flash SenWeaverCoding Nucleo firmware. Builds from firmware/nucleo.
pub fn flash_nucleo_firmware() -> Result<()> {
    ...
    println!("SenWeaverCoding Nucleo firmware flashed successfully.");
