...
impl WebAuthnManager {
    ...
    /// will be stored (typically `~/.senweavercoding/`).
...
mod tests {
    ...
    fn test_config() -> WebAuthnConfig {
        WebAuthnConfig {
            ...
            rp_id: "localhost".into(),
            rp_origin: "http://localhost:42617".into(),
            rp_name: "SenWeaverCoding Test".into(),
        }
    }
    ...
    fn start_registration_returns_valid_challenge() {
        ...
        assert_eq!(creation.rp.name, "SenWeaverCoding Test");
    ...
    fn default_config_has_sane_values() {
        ...
        assert_eq!(config.rp_name, "SenWeaverCoding");
    }
}
