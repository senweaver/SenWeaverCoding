...
/// Maps a single Nevis role to SenWeaverCoding permissions.
...
/// IAM policy engine that maps Nevis roles to SenWeaverCoding tool permissions.
///
...
mod tests {
    ...
    fn test_mappings() -> Vec<RoleMapping> {
        vec![
            ...
            RoleMapping {
                ...
                sen_permissions: vec!["file_read".into(), "memory_search".into()],
    ...
    fn duplicate_normalized_roles_are_rejected() {
        let mappings = vec![
            ...
            RoleMapping {
                nevis_role: " ADMIN ".into(),
                sen_permissions: vec!["file_read".into()],
