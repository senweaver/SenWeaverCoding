...
pub enum DeviceKind {
    ...
    Nucleo,
    /// Unknown VID that passed the SenWeaverCoding firmware ping handshake.
    Generic,
...
impl DeviceRegistry {
    ...
    ///    if the device responds with SenWeaverCoding firmware.
...
impl DeviceRegistry {
    ...
    /// SenWeaverCoding firmware is alive, and re-attaches the transport.
    ///
