...
use super::vector;
use super::vector_index::{VectorIndex, build_default_backend};
...
impl SqliteMemory {
    ...
    pub fn attach_vec_index(
        &self,
        dim: usize,
    ) -> anyhow::Result<crate::memory::vector_index::SqliteVecIndex> {
        let idx = crate::memory::vector_index::SqliteVecIndex::attach(self.conn.clone(), dim)?;
