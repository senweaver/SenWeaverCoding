...
/// and forwards PRIVMSG messages to the `SenWeaverCoding` message bus.
...
mod tests {
    ...
    fn irc_config_serde_roundtrip() {
        ...
        assert_eq!(parsed.username.as_deref(), Some("sen"));
