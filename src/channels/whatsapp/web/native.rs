...
pub struct WhatsAppWebChannel {
    ...
    transcription_manager: Option<std::sync::Arc<crate::channels::pipeline::transcription::TranscriptionManager>>,
...
impl WhatsAppWebChannel {
    ...
    pub fn with_transcription(mut self, config: crate::config::TranscriptionConfig) -> Self {
        ...
        match crate::channels::pipeline::transcription::TranscriptionManager::new(&config) {
            Ok(m) => {
    ...
    pub fn with_dm_mention_patterns(mut self, patterns: Vec<String>) -> Self {
        self.dm_mention_patterns = Arc::new(
            crate::channels::whatsapp::WhatsAppChannel::compile_mention_patterns(&patterns),
        );
        self
    }
    ...
    async fn try_transcribe_voice_note(
        ...
        transcription_manager: Option<&crate::channels::pipeline::transcription::TranscriptionManager>,
    ) -> Option<String> {
    ...
    async fn synthesize_voice_static(
        ...
        let tts_manager = crate::channels::pipeline::tts::TtsManager::new(tts_config)?;
                    ...
                    async move {
                        match event {
                            Event::Message(msg, info) => {
                                ...
                                let content =
                                    match crate::channels::whatsapp::WhatsAppChannel::apply_mention_gating(
