...
import { previewScheduledTasks, previewStatusBar } from '../lib/designPreviewData'

export function ScheduledTasksList() {
  const t = useTranslation()
  const { stats, tasks } = previewScheduledTasks
  const task0 = tasks[0]!
  const task1 = tasks[1]!
  const task2 = tasks[2]!
    ...
    <div className="bg-[#FAF9F5] text-[#1B1C1A] flex min-h-screen overflow-hidden font-[Inter,sans-serif]">
      <aside className="fixed left-0 top-0 h-full w-[280px] bg-[#F4F4F0] flex flex-col p-4 gap-2 z-40">
        <div className="mb-6 px-2 flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-[#C9851A] flex items-center justify-center">
            <span
        ...
        <button className="flex items-center gap-3 px-3 py-2 w-full bg-[#FAF9F5] text-[#1B1C1A] rounded-lg relative before:content-[''] before:absolute before:left-[-8px] before:w-1 before:h-4 before:bg-[#A16900] before:rounded-full font-medium text-sm duration-200 ease-in-out">
          <span
      ...
      <main className="flex-1 flex flex-col ml-[280px] min-w-0 h-screen">
        <header className="bg-[#FAF9F5] h-12 w-full flex justify-between items-center px-6 z-30">
          <div className="flex items-center gap-8">
            <div className="font-[Manrope,sans-serif] font-bold text-[#1B1C1A] uppercase tracking-tighter text-sm">SenWeaverCoding</div>
            <nav className="flex items-center gap-6 font-[Manrope,sans-serif] font-semibold tracking-wide text-sm">
              <a className="text-[#87736D] hover:text-[#A16900] transition-colors" href="#">{t('titlebar.code')}</a>
              <a className="text-[#87736D] hover:text-[#A16900] transition-colors" href="#">{t('titlebar.terminal')}</a>
              <a className="text-[#1B1C1A] border-b-2 border-[#A16900] pb-1" href="#">{t('titlebar.history')}</a>
            </nav>
          </div>
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              <button className="p-1 text-[#87736D] hover:text-[#A16900] transition-colors cursor-pointer active:opacity-70">
            ...
            <button className="font-[Manrope,sans-serif] font-semibold tracking-wide text-sm text-[#87736D] hover:text-[#A16900] transition-colors cursor-pointer active:opacity-70 flex items-center gap-1">
        ...
        <section className="flex-1 overflow-y-auto p-12 bg-[#FAF9F5]">
          <div className="max-w-5xl mx-auto">
            <div className="flex justify-between items-end mb-12">
              ...
              <button className="bg-[#A16900] hover:bg-[#C9851A] text-white px-5 py-2.5 rounded-lg flex items-center gap-2 transition-all shadow-sm font-medium text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
              <div className="bg-[#F4F4F0] p-6 rounded-xl border border-[#DAC1BA]/10">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="material-symbols-outlined text-[#A16900]">analytics</span>
                </div>
                  ...
                  <tr className="group hover:bg-[#F4F4F0]/30 transition-colors">
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-3">
                        <div className="p-2 bg-[#FFE7B3] text-[#A16900] rounded-lg">
                    ...
                    <td className="px-6 py-5 text-right">
                      <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button className="p-2 text-[#87736D] hover:text-[#A16900] transition-colors">
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="bg-[#DBDAD6] rounded-xl p-6 font-[JetBrains_Mono,monospace] text-[13px] leading-relaxed text-[#54433E] overflow-x-auto shadow-inner">
                  ...
                  <div className="mt-4 pt-4 border-t border-[#DAC1BA]/20 flex items-center justify-between">
                    ...
                    <button className="text-[#A16900] font-bold text-xs hover:underline">{t('scheduledPage.viewArtifacts')}</button>
                  </div>
                </div>
              </div>

              <div className="w-full md:w-80 shrink-0">
                <div className="bg-[#C9851A]/10 p-6 rounded-xl border border-[#A16900]/10">
                  <h3 className="font-[Manrope,sans-serif] font-bold text-[#A16900] text-sm mb-3">{t('scheduledPage.resourceAllocation')}</h3>
                  <div className="space-y-4">
                    <div className="space-y-1">
                      ...
                      <div className="w-full h-1 bg-[#DAC1BA]/30 rounded-full overflow-hidden">
                        <div className="h-full bg-[#A16900]" style={{ width: '42%' }}></div>
                      </div>
                    </div>
                    <div className="space-y-1">
                      <div className="flex justify-between text-[11px] font-bold text-[#87736D] uppercase tracking-wider">
                  ...
                  <div className="mt-6">
                    <div className="w-full h-24 rounded-lg bg-gradient-to-br from-[#FFE7B3] via-[#F6CC78]/40 to-[#DAC1BA]/20"></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <footer className="bg-[#FAF9F5] border-t border-[#87736D]/20 fixed bottom-0 left-0 w-full h-8 flex items-center justify-between px-4 z-50">
          <div className="flex items-center gap-4">
            <span className="font-[Inter,sans-serif] text-xs tracking-tight text-[#87736D]">{previewStatusBar.user} &bull; {previewStatusBar.username} &bull; {previewStatusBar.plan}</span>
          ...
          <div className="flex items-center gap-6">
            ...
            <button className="font-[Inter,sans-serif] text-xs tracking-tight text-[#A16900] font-bold hover:bg-[#F4F4F0] px-2 py-0.5 rounded transition-colors flex items-center gap-1">
