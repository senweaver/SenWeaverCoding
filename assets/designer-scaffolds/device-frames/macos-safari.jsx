// when_to_use: macOS Safari window ‚Ä?traffic-light buttons, tab strip,
...
function MacOSSafari({
  ...
  const defaultTabs = tabs || [
    ...
    { title: 'Design', url: 'senweaver.local/design' },
    { title: 'Preview', url: 'senweaver.local/preview' },
  ];
...
function SafariDefaultContent({ dk, url }) {
  return (
    ...
    >
      <div style={{ fontSize: 36, opacity: 0.3 }}>üåê</div>
