...
> Pure flat design: solid fills, no shadows or bevels, bold color blocking, and crisp icons.

## 1. Visual Theme & Atmosphere

Flat design strips all faux-depth — solid color fills, no gradients or shadows, confident color blocking, and clean geometric icons. Hierarchy comes from color, scale, and spacing alone.

**Key characteristics**
- Solid fills, zero shadows or bevels
- Bold color blocking for hierarchy
- Crisp geometric icons and shapes
- Clarity through color and scale, not depth
...
**Do**
- Use solid flat fills and color blocking.
- Rely on scale/spacing for hierarchy.
- Keep icons simple and geometric.
- Bind `tokens.css` into `:root` and reference every value via `var(--*)`.

**Don't**
- Don't add shadows, gradients, or bevels.
- Don't imply depth or material.
- Don't use ornamental textures.
...
- **Iteration rules:** (1) solid fills, zero shadows or bevels; (2) accent `#2563eb` drives interaction; (3) keep type in Inter/Inter; (4) honor the spacing + radius scale exactly.
