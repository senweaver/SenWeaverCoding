...
> Aged-paper nostalgia: warm muted tones, classic serif, and worn textural detail.

## 1. Visual Theme & Atmosphere

Vintage design feels aged and warm — muted earthy tones, classic serif type, and subtle worn texture. It evokes heritage, craft, and a hand-made past.

**Key characteristics**
- Warm muted earthy tones
- Classic serif type
- Subtle worn/aged texture
- Heritage, craft atmosphere
...
**Do**
- Use warm muted tones and serif type.
- Add subtle aged texture.
- Evoke heritage and craft.
- Bind `tokens.css` into `:root` and reference every value via `var(--*)`.

**Don't**
- Don't use bright modern neon.
- Don't go ultra-clean and flat.
- Don't over-texture into noise.
...
- **Iteration rules:** (1) warm muted earthy tones; (2) accent `#8f5d24` drives interaction; (3) keep type in Georgia/Inter; (4) honor the spacing + radius scale exactly.
