# Design System — Storytelling

> Category: Creative & Artistic
> Narrative scroll UI: sequenced sections, cinematic pacing, and immersive transitions.

## 1. Visual Theme & Atmosphere

Storytelling design guides a narrative — sequenced full-bleed sections, cinematic pacing, large imagery, and transitions that carry the reader chapter to chapter.

**Key characteristics**
- Sequenced full-bleed sections
- Cinematic scroll pacing
- Large immersive imagery
- Narrative transitions between chapters
...
**Do**
- Sequence sections like chapters.
- Pace the scroll cinematically.
- Use large immersive imagery.
- Bind `tokens.css` into `:root` and reference every value via `var(--*)`.

**Don't**
- Don't present a flat undifferentiated grid.
...
- **Iteration rules:** (1) sequenced full-bleed sections; (2) accent `#9b5b32` drives interaction; (3) keep type in Georgia/Inter; (4) honor the spacing + radius scale exactly.
