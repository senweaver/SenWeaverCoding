...
> Fast, kinetic UI: punchy accents, dynamic angles, and motion-ready energy.

## 1. Visual Theme & Atmosphere

Energetic design feels fast — punchy accent color, dynamic diagonal cues, and layouts that imply motion. It is upbeat, sporty, and built to feel alive.

**Key characteristics**
- Punchy, high-energy accent
- Dynamic angles and diagonal motion cues
- Upbeat, sporty atmosphere
...
**Do**
- Use punchy accents and dynamic angles.
- Imply motion and speed.
- Keep interactions lively.
- Bind `tokens.css` into `:root` and reference every value via `var(--*)`.

**Don't**
- Don't feel static or sleepy.
- Don't mute the energetic accent.
- Don't over-pad until it feels slow.
...
- **Iteration rules:** (1) punchy, high-energy accent; (2) accent `#ff6b00` drives interaction; (3) keep type in Inter/Inter; (4) honor the spacing + radius scale exactly.
