# Design System — Artistic

> Category: Creative & Artistic
> Gallery-grade design: painterly color, generous canvas, and image-led composition.

## 1. Visual Theme & Atmosphere

Artistic design treats the page as a canvas — painterly color, generous negative space, and image-led composition where typography supports the artwork.

**Key characteristics**
- Painterly, curated color
- Generous gallery canvas
- Image-led composition
- Type in service of the artwork
...
**Do**
- Give artwork generous canvas.
- Use painterly curated color.
- Let imagery lead.
- Bind `tokens.css` into `:root` and reference every value via `var(--*)`.

**Don't**
- Don't crowd the canvas.
- Don't let type fight the artwork.
- Don't use clashing color.
...
- **Iteration rules:** (1) painterly, curated color; (2) accent `#9b5b32` drives interaction; (3) keep type in Georgia/Inter; (4) honor the spacing + radius scale exactly.
