...
> Enterprise brand UI: structured grids, conservative palette, and consistent components.

## 1. Visual Theme & Atmosphere

Corporate design is structured and on-brand — disciplined grids, a conservative palette, consistent components, and clear information density for large organizations.

**Key characteristics**
- Disciplined structured grids
- Conservative, on-brand palette
- Consistent reusable components
- Clear business information density
...
**Do**
- Use disciplined grids.
- Keep the palette conservative.
- Reuse consistent components.
- Bind `tokens.css` into `:root` and reference every value via `var(--*)`.

**Don't**
- Don't improvise off-system.
- Don't use trendy/loud styling.
- Don't break grid discipline.
...
- **Iteration rules:** (1) disciplined structured grids; (2) accent `#2563eb` drives interaction; (3) keep type in Inter/Inter; (4) honor the spacing + radius scale exactly.
