...
> Cozy hospitality UI: warm browns, handwritten touches, and inviting menu-like layout.

## 1. Visual Theme & Atmosphere

Cafe design is cozy and inviting — warm coffee-toned surfaces, a handwritten or characterful display, and menu-like layouts that feel hospitable and crafted.

**Key characteristics**
- Warm coffee-toned surfaces
- Characterful/handwritten display
- Menu-like inviting layout
- Cozy, hospitable atmosphere
...
**Do**
- Use warm coffee tones.
- Add a characterful display face.
- Lay out like an inviting menu.
- Bind `tokens.css` into `:root` and reference every value via `var(--*)`.

**Don't**
- Don't use cold tech surfaces.
- Don't go starkly minimal.
- Don't feel impersonal.
...
- **Iteration rules:** (1) warm coffee-toned surfaces; (2) accent `#9b5b32` drives interaction; (3) keep type in Georgia/Inter; (4) honor the spacing + radius scale exactly.
