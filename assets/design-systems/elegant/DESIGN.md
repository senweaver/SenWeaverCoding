...
> Graceful luxury-adjacent UI: serif touches, fine lines, and generous refined space.

## 1. Visual Theme & Atmosphere

Elegant design is graceful and upscale — fine hairlines, serif or refined display touches, generous spacing, and a restrained palette. It reads as quality and care.

**Key characteristics**
- Fine hairlines and delicate detail
- Serif or refined display touches
- Generous, refined spacing
- Restrained upscale palette
...
**Do**
- Use fine lines and generous space.
- Add a refined serif touch.
- Keep the palette restrained.
- Bind `tokens.css` into `:root` and reference every value via `var(--*)`.

**Don't**
- Don't use heavy, blunt elements.
- Don't crowd the layout.
- Don't introduce loud color.
...
- **Iteration rules:** (1) fine hairlines and delicate detail; (2) accent `#9b5b32` drives interaction; (3) keep type in Georgia/Inter; (4) honor the spacing + radius scale exactly.
