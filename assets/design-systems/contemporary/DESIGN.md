# Design System — Contemporary

> Category: Modern & Minimal
> Of-the-moment design: current trends, balanced neutrals, and fresh accent color.

## 1. Visual Theme & Atmosphere

Contemporary design reflects current taste — balanced neutral surfaces, fresh accent color, comfortable density, and modern type. It feels new without being trend-chasing.

**Key characteristics**
- Current, balanced neutrals
- Fresh accent color
- Comfortable modern density
- Up-to-date type rhythm
...
**Do**
- Keep it current and balanced.
- Use a fresh accent.
- Maintain comfortable density.
...
- **Iteration rules:** (1) current, balanced neutrals; (2) accent `#2563eb` drives interaction; (3) keep type in Inter/Inter; (4) honor the spacing + radius scale exactly.
