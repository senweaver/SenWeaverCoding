...
> 3D-perspective UI: subtle depth transforms, angled planes, and dimensional motion.

## 1. Visual Theme & Atmosphere

Perspective design adds dimension — subtle 3D transforms, angled planes, parallax, and depth-aware motion that gives the flat screen a sense of space.

**Key characteristics**
- Subtle 3D perspective transforms
- Angled, dimensional planes
...
**Do**
- Use subtle perspective transforms.
- Add parallax/depth cues.
- Keep motion depth-aware.
- Bind `tokens.css` into `:root` and reference every value via `var(--*)`.

**Don't**
- Don't overdo tilt into disorientation.
- Don't flatten away all depth.
- Don't let 3D hurt legibility.
...
- **Iteration rules:** (1) subtle 3d perspective transforms; (2) accent `#2563eb` drives interaction; (3) keep type in Inter/Inter; (4) honor the spacing + radius scale exactly.
