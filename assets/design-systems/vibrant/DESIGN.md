...
> Energetic, saturated palette: lively color pairings, playful contrast, and upbeat surfaces.

## 1. Visual Theme & Atmosphere

Vibrant design is upbeat and colorful — saturated accents, lively pairings, and energetic contrast. It feels fresh and modern while staying organized and legible.

**Key characteristics**
- Saturated, lively color pairings
- Energetic accent + supporting hues
- Playful but organized contrast
- Bright surfaces with crisp text
...
**Do**
- Pair saturated colors intentionally.
- Keep energy organized and legible.
- Use the accent for key moments.
- Bind `tokens.css` into `:root` and reference every value via `var(--*)`.

**Don't**
- Don't let color become chaotic noise.
- Don't sacrifice text contrast.
- Don't use muddy or dull tones.
...
- **Iteration rules:** (1) saturated, lively color pairings; (2) accent `#ff6b00` drives interaction; (3) keep type in Inter/Inter; (4) honor the spacing + radius scale exactly.
