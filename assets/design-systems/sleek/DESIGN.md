...
> Polished premium-tech UI: dark or crisp surfaces, tight type, and refined micro-detail.

## 1. Visual Theme & Atmosphere

Sleek design is polished and contemporary — smooth surfaces, tight tracking, refined spacing, and subtle premium detail. It feels engineered and high-end.

**Key characteristics**
- Polished, smooth surfaces
- Tight display tracking
- Refined spacing and micro-detail
- Premium, engineered feel
...
**Do**
- Use tight tracking and refined spacing.
- Keep surfaces smooth and polished.
- Sweat micro-detail.
- Bind `tokens.css` into `:root` and reference every value via `var(--*)`.

**Don't**
- Don't feel rough or busy.
- Don't use loose, casual spacing.
- Don't add clutter that breaks polish.
...
- **Iteration rules:** (1) polished, smooth surfaces; (2) accent `#60a5fa` drives interaction; (3) keep type in Inter/Inter; (4) honor the spacing + radius scale exactly.
