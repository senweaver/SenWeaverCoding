# Design System — Colorful

> Category: Bold & Expressive
> Multi-hue, joyful design: a broad palette, color-coded sections, and expressive accents.

## 1. Visual Theme & Atmosphere

Colorful design embraces a broad palette — multiple distinct hues used to code sections and inject personality. It is joyful and expressive while keeping a clear system behind the rainbow.

**Key characteristics**
- Broad multi-hue palette
- Color-coded sections and categories
- Expressive, playful accents
- Systematic use so color stays meaningful
...
**Do**
- Code sections by hue consistently.
- Keep a system behind the palette.
- Balance color with neutral rest areas.
- Bind `tokens.css` into `:root` and reference every value via `var(--*)`.

**Don't**
- Don't use random unsystematic color.
- Don't overwhelm without neutral breathing space.
- Don't drop text contrast for the sake of color.
...
- **Iteration rules:** (1) broad multi-hue palette; (2) accent `#ff6b00` drives interaction; (3) keep type in Inter/Inter; (4) honor the spacing + radius scale exactly.
