...
> Studio-creative design: expressive layout, mixed media, and confident artistic color.

## 1. Visual Theme & Atmosphere

Creative design is a studio playground — expressive asymmetric layout, mixed media, bold artistic color, and a willingness to surprise while staying usable.

**Key characteristics**
- Expressive asymmetric layout
- Mixed-media, layered composition
- Bold artistic color
- Surprising yet usable
...
**Do**
- Compose expressively and asymmetrically.
- Use bold artistic color.
- Surprise while staying usable.
- Bind `tokens.css` into `:root` and reference every value via `var(--*)`.

**Don't**
- Don't default to safe grids.
- Don't mute the artistic voice.
- Don't sacrifice usability for art.
...
- **Iteration rules:** (1) expressive asymmetric layout; (2) accent `#ff6b00` drives interaction; (3) keep type in Inter/Inter; (4) honor the spacing + radius scale exactly.
