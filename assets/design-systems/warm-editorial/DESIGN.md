...
> Category: Starter
> Warm editorial starter: paper tones, readable serif-friendly type, and gentle accents.

## 1. Visual Theme & Atmosphere

Warm Editorial is a cozy content starter — warm paper-toned surfaces, readable type tuned for prose, gentle accents, and a relaxed reading rhythm. Ideal for blogs, docs, and content sites.

**Key characteristics**
- Warm paper-toned surfaces
- Prose-tuned readable type
- Gentle, low-key accents
...
**Do**
- Use warm paper tones.
- Tune type for readable prose.
- Keep accents gentle.
- Bind `tokens.css` into `:root` and reference every value via `var(--*)`.

**Don't**
- Don't use cold tech surfaces.
- Don't cramp the reading rhythm.
- Don't use loud accents.
...
- **Iteration rules:** (1) warm paper-toned surfaces; (2) accent `#9b5b32` drives interaction; (3) keep type in Georgia/Inter; (4) honor the spacing + radius scale exactly.
