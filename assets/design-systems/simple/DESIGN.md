...
> Effortless minimalist UI: few elements, obvious hierarchy, and frictionless flows.

## 1. Visual Theme & Atmosphere

Simple design removes everything non-essential — few elements per view, obvious hierarchy, and an unmistakable primary action. Easy to scan, easy to use.

**Key characteristics**
- Few elements per view
- Obvious, single-path hierarchy
- One unmistakable primary action
- Frictionless, reduced flows
...
**Don't**
- Don't add optional clutter.
- Don't present competing actions.
- Don't hide the main task.
...
- **Iteration rules:** (1) few elements per view; (2) accent `#2563eb` drives interaction; (3) keep type in Inter/Inter; (4) honor the spacing + radius scale exactly.
